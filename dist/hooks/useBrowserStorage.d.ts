...
export declare function useBrowserStorage<T = any>(key: string, defaultWhenUndefined: T | null | undefined, storage: Storage, options?: BrowserStorageOptions<T>): StorageState<T>;
